...
python benchmarks/b03_io_throughput.py --provider hf

log "B04 concurrent create N=5"
python benchmarks/b04_concurrent_create.py --provider hf --n 5
log "B04 concurrent create N=20"
python benchmarks/b04_concurrent_create.py --provider hf --n 20
...
python benchmarks/b06_long_running.py --provider hf
